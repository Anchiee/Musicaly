...
export default function login() {
    return(
        <main className="size-full flex">
            <section className="w-1/4 flex flex-col items-center py-10 gap-6 self-center">
                <Header text="sign-up"/>
                <section className="flex gap-24 border-b-[1px] border-b-gray-300 w-[60%] pb-5 justify-center">
